...
/** Full-bleed animated MENA map. Copy stays below — nothing over the graphic. */
export function Student100Hero() {
  return (
    <section
      className="s100-hero relative overflow-hidden"
      aria-label="Animated map of MENA capital cities"
    >
      <svg
        className="s100-hero-map h-full w-full"
