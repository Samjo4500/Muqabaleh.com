    ...
    <div className="relative" style={{ perspective: 1000 }}>
      ...
      >
        <div className="relative z-10 mb-4 flex items-center gap-2 border-b border-white/10 pb-3">
          ...
          <span className="ms-2 truncate text-xs text-[var(--text-muted)]">{t('simUrl')}</span>
        </div>

        <div className="relative z-10 mb-3 flex items-center justify-between gap-3">
          <p className="text-sm font-semibold text-[var(--text-primary)]">{t('simTitle')}</p>
          <span className="text-xs text-[var(--text-muted)]">{t('simProgress')}</span>
        </div>
        ...
        <div className="relative z-10 mb-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] text-[var(--text-muted)]">{t('simLevelLabel')}</p>
        ...
        <div className="relative z-10 flex items-center justify-between gap-3">
          <span className="text-xs text-[var(--text-muted)]">{t('simListening')}</span>
