...
export function CrystalHero() {
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden px-4 pb-16 pt-28 md:px-8">
      <AuroraBlobs />
      <motion.div
        className="glass-strong relative z-10 w-full max-w-4xl rounded-3xl px-6 py-10 text-center md:px-12 md:py-14"
        ...
        >
          ...
          >
            <Link href="/demo" className="glass-button inline-flex w-full justify-center sm:w-auto">
              <span className="relative z-10 gradient-text">{t('hero.ctaPrimary')}</span>
            </Link>
          </motion.div>
