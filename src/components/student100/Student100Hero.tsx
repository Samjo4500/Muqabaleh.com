...
/** Campaign banner: muted MENA map, glowing wordmark, offer, brand CTA. */
        ...
        <div className="s100-hero-stage">
          ...
          >
            ...
            {MENA_CAPITALS.map((city, i) => {
              ...
              const delay = { animationDelay: `${i * 0.18}s` };
              return (
                <g key={city.code}>
                  <circle className="s100-pin-ring" cx={x} cy={y} r="9" style={delay} />
                  <circle className="s100-pin" cx={x} cy={y} r="2.6" style={delay} />
                </g>
              );
            })}
          </svg>
